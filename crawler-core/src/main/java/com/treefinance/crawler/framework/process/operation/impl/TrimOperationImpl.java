...
public class TrimOperationImpl extends Operation<TrimOperation> {
    ...
    @Override
    protected Object doOperation(@Nonnull TrimOperation operation, @Nonnull Object operatingData, @Nonnull SpiderRequest request, @Nonnull SpiderResponse response)
        throws Exception {
