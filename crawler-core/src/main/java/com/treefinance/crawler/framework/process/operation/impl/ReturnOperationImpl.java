...
public class ReturnOperationImpl extends Operation<ReturnOperation> {
    ...
    @Override
    protected Object doOperation(@Nonnull ReturnOperation operation, @Nonnull Object operatingData, @Nonnull SpiderRequest request, @Nonnull SpiderResponse response)
        throws Exception {
