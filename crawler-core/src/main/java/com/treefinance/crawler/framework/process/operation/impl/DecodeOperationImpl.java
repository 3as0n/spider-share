...
public class DecodeOperationImpl extends Operation<DecodeOperation> {
    ...
    @Override
    protected Object doOperation(@Nonnull DecodeOperation operation, @Nonnull Object operatingData, @Nonnull SpiderRequest request, @Nonnull SpiderResponse response)
        throws Exception {
