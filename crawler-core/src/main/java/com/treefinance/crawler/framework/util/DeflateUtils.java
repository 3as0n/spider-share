...
public class DeflateUtils {
    ...
    /**
     * Returns an inflated copy of the input array. If the deflated input has been truncated or corrupted, a best-effort
     * attempt is made to inflate as much as possible. If no data can be extracted <code>null</code> is returned.
     */
    ...
    /**
     * Returns an inflated copy of the input array, truncated to <code>sizeLimit</code> bytes, if necessary. If the
     * deflated input has been truncated or corrupted, a best-effort attempt is made to inflate as much as possible. If
     * no data can be extracted <code>null</code> is returned.
     */
    public static final byte[] inflateBestEffort(byte[] in, int sizeLimit) {
        ...
        while (true) {
            try {
                ...
                LOG.error("Caught Exception in inflateBestEffort", e);
                break;
            }
        }
        try {
