    ...
    public class Entry extends HtmlResource {
        ...
        public boolean isEntryValid() {
            ...
            try {
                ...
                log.warn("Error loading font " + fontName + "!", e);
            }
        ...
        private byte[] loadOtherTypeFont(PDStream fontFile) throws IOException {
            ...
            try {
                ...
                log.error("Issue converting Bare CFF font or the font type is not supportedby Pdf2Dom, " + "Font: " + fontName, ex);
                // don't barf completley for font conversion issue, html will still be useable
                // without.
                return new byte[0];
            }
        }
