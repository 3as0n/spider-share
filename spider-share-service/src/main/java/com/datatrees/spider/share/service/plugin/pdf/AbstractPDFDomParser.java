...
import com.datatrees.spider.share.service.plugin.pdf.pdfdom.BoxStyle;
import com.datatrees.spider.share.service.plugin.pdf.pdfdom.FontTable;
import com.datatrees.spider.share.service.plugin.pdf.pdfdom.ImageResource;
import com.datatrees.spider.share.service.plugin.pdf.pdfdom.ImageUtils;
import com.datatrees.spider.share.service.plugin.pdf.pdfdom.PathSegment;
import com.datatrees.spider.share.service.plugin.pdf.pdfdom.TextMetrics;
...
public abstract class AbstractPDFDomParser extends PDFTextStripper {
     ...
     *
     * @param disableImageData when set to <code>true</code> the image data is not copied to the document tree. The
     *        eventual <code>img</code> elements will have an empty <code>src</code> attribute.
     */
     ...
     * {@link AbstractPDFDomParser#curstyle} property.
     *
    ...
    protected void processOperator(Operator operator, List<COSBase> arguments) throws IOException {
        ...
        /*
         * System.out.println("Operator: " + operation + ":" + arguments.size()); if
         * (operation.equals("sc") || operation.equals("cs")) { System.out.print("  "); for (int i =
         * 0; i < arguments.size(); i++) System.out.print(arguments.get(i) + " ");
         * System.out.println(); }
         */
    ...
    protected void processTextPosition(TextPosition text) {
        if (text.isDiacritic()) {
            ...
            /*
             * float[] c = transformPosition(text.getX(), text.getY()); cur_x = c[0]; cur_y = c[1];
             */
            cur_x = text.getX();
            cur_y = text.getY();

            /*
             * System.out.println("Text: " + text.getCharacter()); System.out.println(" Font size: "
             * + text.getFontSize() + " " + text.getFontSizeInPt() + "pt");
             * System.out.println(" Width: " + text.getWidth()); System.out.println(" Width adj: " +
             * text.getWidthDirAdj()); System.out.println(" Height: " + text.getHeight());
             * System.out.println(" Height dir: " + text.getHeightDir());
             * System.out.println(" XScale: " + text.getXScale()); System.out.println(" YScale: " +
             * text.getYScale());
             */
